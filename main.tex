...
\addcontentsline{toc}{section}{\protect\numberline{}Uso de pacotes e criação da biblioteca}%
...
\begin{figure}[H]
    \centering
    \subfloat[\centering R0\textunderscore caso1.jpg ]{{\includegraphics[width=3.3cm]{images_original/13/R0_caso1.jpg}}}%
    \qquad
    \subfloat[\centering R0\textunderscore caso2.jpg ]{{\includegraphics[width=3.3cm]{images_original/13/R0_caso2.jpg}}}%
    \qquad
      \subfloat[\centering R3\textunderscore caso1.jpg ]{{\includegraphics[width=3.3cm]{images_original/13/R3_caso1.jpg}}}%
    \qquad
        \subfloat[\centering R3\textunderscore caso2.jpg ]{{\includegraphics[width=3.3cm]{images_original/13/R3_caso2.jpg}}}%
\end{figure}
...
\lstinputlisting[language=Python]{sources/13_texture_d_1.py}

Após a execução do código o seguinte vetor é exibido.

\lstinputlisting[language=Bash]{outputs/13_texture_d_1.txt}

Para gerar o vetor da imagem R0\textunderscore caso2.jpg foi utilizado o código abaixo.

\lstinputlisting[language=Python]{sources/13_texture_d_2.py}

Após a execução do código o seguinte vetor é exibido.

\lstinputlisting[language=Bash]{outputs/13_texture_d_2.txt}

Para gerar o vetor da imagem R3\textunderscore caso1.jpg foi utilizado o código abaixo.

\lstinputlisting[language=Python]{sources/13_texture_d_3.py}

Após a execução do código o seguinte vetor é exibido.

\lstinputlisting[language=Bash]{outputs/13_texture_d_3.txt}

Para gerar o vetor da imagem R3\textunderscore caso2.jpg foi utilizado o código abaixo.

\lstinputlisting[language=Python]{sources/13_texture_d_4.py}

Após a execução do código o seguinte vetor é exibido.

\lstinputlisting[language=Bash]{outputs/13_texture_d_4.txt}
...
\lstinputlisting[language=Python]{sources/13_texture_e_3D_1.py}

Após a execução o seguinte gráfico é exibido.

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.8]{images_generate/13/R0_caso1_grafico3d.png}
...
\lstinputlisting[language=Python]{sources/13_texture_e_barra_1.py}

Após a execução o seguinte gráfico é exibido.

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.8]{images_generate/13/R0_caso1_grafico_barras.png}
